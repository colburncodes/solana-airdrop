...
// STEP-3 Func: GetWalletBalance
const getWalletBalance = async () => {
    try {
        const connection = new Connection(clusterApiUrl("devnet"), "confirmed");
        const myWallet = await Keypair.fromSecretKey(secretKey); // create wallet obj
        const walletBalance = await connection.getBalance(new PublicKey(myWallet.publicKey)); // query wallet details
...
// STEP-4 Func: Airdropping SOL (in terms of LAMPORTS)
